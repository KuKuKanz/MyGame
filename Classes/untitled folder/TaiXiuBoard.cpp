...
void TaiXiuBoard::drawBoard(){
    ...
    _dialog->setScale(_scaleX, _scaleY);
    ...
    _btnHistory->setNormalizedPosition(Vec2(0.0192,0.8809));
    ...
    
    {
        ...
        _txtXiuBet->setColor(Color3B::YELLOW);
        _txtXiuBet->setTag(kTagTextTaiBet);
    ...
    
    {
        ...
        _txtTaiBet->setColor(Color3B::YELLOW);
        _txtTaiBet->setTag(kTagTextXiuBet);
    ...
    _txtSubMoney->setTextHorizontalAlignment(TextHAlignment::CENTER);
    _txtSubMoney->setTextVerticalAlignment(TextVAlignment::CENTER);
    _txtSubMoney->setTextColor(Color4B::RED);
    ...
    _txtAddMoney->setTextHorizontalAlignment(TextHAlignment::CENTER);
    _txtAddMoney->setTextVerticalAlignment(TextVAlignment::CENTER);
    _txtAddMoney->setTextColor(Color4B::YELLOW);
    ...
    
    {
        ...
        _txtMoneyBet->setNormalizedPosition(Vec2(0.0657,0.2319));
        _txtMoneyBet->setTag(43);
        _dialog->addChild(_txtMoneyBet);
        ...
        _txtUserBet->setNormalizedPosition(Vec2(1.9422,0.5));
        ...
        _txtMoneyBet->addChild(_txtUserBet);
