...
enum CursorDirection{
    CURSOR_ON_SIDE_LEFT = -1,
    CURSOR_ON_SIDE_RIGHT = 1
};
...
public:
    ...
    void clock(float dt);
    void showBoardResult(bool _enable);
    
    CursorDirection _cursorSide;

    
    CC_SYNTHESIZE(Button*, _cursor, _Cursor);
    CC_SYNTHESIZE(ImageView*, _backGroundCursor, _BackGroundCursor);
    
private:
    Button* cursor;
    
    ImageView* _backGroundTXResult;
    bool _showBackGroundTxResult;
